...
var languages = ["Python", "React", "CSS", "HTML", "Javascript", "SASS", "Vue", "Jquery", "a proprietary coding language based on Egyptian hieroglyphs", "a Turing machine", "a magic 8 ball", "Ancient Sumerian", "C++", "binary", "trinary (like binary but better)"]
var bullshit = ["synergy", "cohesion", "fusion", ""]

var verbPresent = ["makes", "creates", "builds", "writes", "uses", "drives", "shapes", "erects", "constructs", "assembles", "produces", "powers"];
...
var butFor = ["dogs", "horses", "single-mothers", "flat-earthers", "fundamentalist Christians", "large teams", "enterprise applications", "long-distance hikers", "travellers", "hackers", ""]
var BillGates = ["Bill Gates", "Tim Cook", "William Defoe", "Eric Andre", "Steve Wozniak", "Elon Musk", "Pete Cashmore", "Kanye West", "The Pope", "my mother", "your favourite uncle", "Sheryl Sandberg", "John Doerr", "Virginia Rometty", "Tim Armstrong", "Dennis Crowley"]
var actionArray = ["eat breakfast", "watch movies", "read the news", "get inspiration", "work", "live", "drive", "eat", "consume", "swim", "go for runs", "enjoy life", "see the world", "use social media", "use their computers", "engage online", "see the world", "travel", "copulate"]
