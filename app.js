...
var butFor = ["dogs", "horses", "single-mothers", "flat-earthers", "fundamentalist Christians", "large teams", "enterprise applications", "long-distance hikers", "travellers", "hackers", "large and also small people", "venture capitalists", "increasing cash flow", "entrepreneurs", "strong independent men", "big boys", "big boiz", "the clinically insane", "geriatrics", "grandfathers with no grandchildren", "people who say they don't use Tinder but actually do use Tinder", "your mother (yes, you)", "getting better at Tennis", "finding your true self", "getting in touch with Mother Gaia", "making sure 5g doesn't come to your neighbourhood", "expelling undesirables", "showing people you aren't racist", "virtue signalling", "pretending you aren't a scared lonely little boy", "big-upping your boys", "screaming into the void", "making sure you do not go gentle into that good night", "making sure you eat all your vegetables (even the gross ones)", "getting you fired up", "teaching intersectional feminisism to Tucker Carlson fans", "praying to Jesus and Allah at the same time", "ignoring your social and moral responsibilities", "breaking the shackles that bound you to the corporeal world", "destroying the social contract and spreading rampant individualism all over everyone", "people who don't believe in technology", "people who don't believe in science", "people who don't believe in the scientific method"]
var BillGates = ["Bill Gates", "Tim Cook", "William Defoe", "Eric Andre", "Steve Wozniak", "Elon Musk", "Pete Cashmore", "Kanye West", "The Pope", "my mother", "your favourite uncle", "Sheryl Sandberg", "John Doerr", "Virginia Rometty", "Tim Armstrong", "Dennis Crowley", "Jesus Christ", "Dennis Renolds", "Shiv Nadar", "Masayoshi Son", "Michael Dell", "Jack Ma", "Steve Ballmer", "Sergey Brin", "Larry Ellison", "Seb Senior", "grandpappi Seb", "old man Williams who lives down the road from me and sometimes yells racialized obscenities at elderly passerbys"]
